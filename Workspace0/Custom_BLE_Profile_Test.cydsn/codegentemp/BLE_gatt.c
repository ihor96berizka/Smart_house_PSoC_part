    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'C', (uint8)'Y', (uint8)' ', (uint8)'C', (uint8)'u', (uint8)'s', (uint8)'t', (uint8)'o', (uint8)'m',
...
const uint8 cyBle_attUuid128[][16u] = {
    /* RGB_LED */
    { 0xB9u, 0x90u, 0x2Fu, 0x71u, 0xC9u, 0xA9u, 0x59u, 0x96u, 0x89u, 0x46u, 0xBFu, 0xCFu, 0xBCu, 0x9Du, 0x2Au, 0xAEu },
    /* RGB_LED_CONTROL */
    { 0x13u, 0xFCu, 0x76u, 0x05u, 0xC0u, 0x64u, 0xC5u, 0xB7u, 0x4Au, 0x43u, 0xD0u, 0x76u, 0x84u, 0x0Fu, 0x6Au, 0x01u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0010u, (void *)&cyBle_attUuid128[0] }, /* RGB_LED UUID */
    { 0x0010u, (void *)&cyBle_attUuid128[1] }, /* RGB_LED_CONTROL UUID */
    { 0x0004u, (void *)&cyBle_attValues[29] }, /* RGB_LED_CONTROL */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x13u] = {
    ...
    { 0x0012u, 0x0F84u /* RGB_LED_CONTROL                     */, 0x090A0101u /* rd,wr */, 0x0013u, {{0x0004u, (void *)&cyBle_attValuesLen[9]}} },

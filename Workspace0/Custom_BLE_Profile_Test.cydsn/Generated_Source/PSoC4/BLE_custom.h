...
#define CYBLE_RGB_LED_SERVICE_INDEX   (0x00u) /* Index of RGB_LED service in the cyBle_customs array */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_INDEX   (0x00u) /* Index of RGB_LED_CONTROL characteristic */
...
#define CYBLE_RGB_LED_SERVICE_HANDLE   (0x0010u) /* Handle of RGB_LED service */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x0011u) /* Handle of RGB_LED_CONTROL characteristic declaration */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x0012u) /* Handle of RGB_LED_CONTROL characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0013u) /* Handle of Characteristic User Description descriptor */
